...
tipo_interes_anual = 2  # Tipo de interés anual para la opción 2
producto_vinculado_inicial = 18.5  # Producto vinculado seguro de hogar en la opción 2 (18.5€/mes)
...
coste_total = 0
coste_seguro_anual = producto_vinculado_inicial * 12  # Seguro anual inicial (primer año)

# Sumar el coste durante el primer año (con el seguro vinculado)
coste_total += cuota_mensual_hipoteca * 12  # Cuota mensual * 12 meses (primer año)
coste_total += coste_seguro_anual  # Añadir el coste del seguro del primer año
...
print(f"El coste total de la Opción 2 con incremento del seguro de hogar es: {coste_total:.2f}€")
