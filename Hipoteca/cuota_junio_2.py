...
# Nuevo tipo de interés anual (2%)
tipo_interes_anual = 2  # Tipo de interés anual actualizado (en porcentaje)
...
print(f"La nueva cuota mensual con un tipo de interés del 2% es: {cuota:.2f}€")
